...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang="ko" data-scroll-behavior="smooth" suppressHydrationWarning>
    ...
    <body><Header/>{children}<footer className="site-footer"><div className="shell"><span className="footer-brand">NEX<span>PLAY</span></span><p>다음에 플레이할 게임을 발견하는 가장 빠른 방법.</p><ArchiveStatus/><nav className="footer-legal" aria-label="약관"><Link href="/terms">이용약관</Link><Link href="/privacy">개인정보처리방침</Link></nav><span>© 2026 RUBI-ON</span></div></footer></body>
  </html>;
}
